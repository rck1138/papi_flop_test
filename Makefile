...
flop_count_ser_sp: flop_count_ser_sp.cxx
	$(CXX) -o flop_count_ser_sp $(INC) $(CFLAGS) $(LIB) $<

flop_count_ser_sp_pf: flop_count_ser_sp.cxx
	$(CXX) -o flop_count_ser_sp_pf -DPREFETCH $(INC) $(CFLAGS) $(LIB) $<

flop_count_ser_dp: flop_count_ser_dp.cxx
	$(CXX) -o flop_count_ser_dp $(INC) $(CFLAGS) $(LIB) $<

flop_count_ser_dp_pf: flop_count_ser_dp.cxx
	$(CXX) -o flop_count_ser_dp_pf -DPREFETCH $(INC) $(CFLAGS) $(LIB) $<
